...
-(void)loadView{
    ...
    [_theFbquanalertV setType:FBQuanAlertViewTypeHaveJuhua thetext:@"正在加载，请稍后..."];
...
-(void)getDataFromDocument{
    ...
    thearray=[StadU objectForKey:@"SuggestFriendViewControllerADDRESSBOOKARRAY"];
...
-(void)matchingPostWithnumber:(NSString *)thenumber strname:(NSString *)thename{
    ...
    request = [ASIFormDataRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:GETSUGGESTFRIENDLISTAPI ,[SzkAPI getAuthkey]]]];
...
-(void)testfailed:(ASIHTTPRequest*)request{
    ...
    UIAlertView *alertV=[[UIAlertView alloc]initWithTitle:nil message:@"提示" delegate:nil cancelButtonTitle:@"网络连接失败" otherButtonTitles:nil, nil];
    [alertV show];
...
-(void)testfinished:(ASIHTTPRequest*)reques{
    ...
    [standUser setObject:arrayinfo forKey:@"SuggestFriendViewControllerADDRESSBOOKARRAY"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    OfficalSuggestCell *cell=[tableView dequeueReusableCellWithIdentifier:stridentifier];
    
    if (!cell) {
        
        cell=[[OfficalSuggestCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:stridentifier];
    }
